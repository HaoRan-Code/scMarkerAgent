...
The package also installs `scmarkeragent-r`, which runs the R arm's pipeline (bundled with
this package) through `Rscript` when the R dependencies are present. The

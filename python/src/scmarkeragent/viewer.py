...
<header class="topbar"><div class="topbar-inner">
  ...
  <div class="contract">Reference-free annotation · one dataset</div>
</div></header>
<main>
  ...
  <div class="notice"><strong>Reference-free output.</strong>
  No author annotation, purity, reference metric, or secondary label is read or displayed.</div>
  <div class="cards">
    <div class="card"><div class="metric-label">Cells</div><div class="metric-value">{total_cells:,}</div><div class="metric-note">after quality control</div></div>

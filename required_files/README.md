...
The marker resource is available from [Zenodo](https://doi.org/10.5281/zenodo.22812457)
as `scmarkeragent-curated.tar.gz`. Both download commands use the `archive_url` in
`resource_index.json` and verify the downloaded files against its size and SHA-256
checksums.
